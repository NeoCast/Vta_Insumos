...
Partial Class Ayuda
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "Ante cualquier inconveniente comuniquese con el soporte tecnico."
        '
        'Label2
        '
        ...
        Me.Label2.Text = "En los horarios de 8 hs a 21hs"
        '
        'Label3
        '
        ...
        Me.Label4.Text = "Mail: soprtetecnicoMM@gmail.com"
        '
        'Ayuda
        '
